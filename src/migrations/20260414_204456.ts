...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum__pages_v_published_locale" AS ENUM('he', 'en');
  ...
  CREATE TYPE "public"."enum__variants_v_published_locale" AS ENUM('he', 'en');
  ...
  CREATE TYPE "public"."enum_products_type" AS ENUM('print', 'original');
  ...
  CREATE TYPE "public"."enum__products_v_version_type" AS ENUM('print', 'original');
  CREATE TYPE "public"."enum__products_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__products_v_published_locale" AS ENUM('he', 'en');
  ...
  CREATE TABLE "variants" (
  	...
  	"price_in_i_l_s" numeric,
  	"price_in_i_l_s_enabled" boolean DEFAULT true,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  CREATE TABLE "_variants_v" (
  	...
  	"version_price_in_i_l_s" numeric,
  	"version_price_in_i_l_s_enabled" boolean DEFAULT true,
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  ...
  CREATE TABLE "products" (
  	...
  	"price_in_u_s_d_enabled" boolean,
  	"price_in_u_s_d" numeric,
  	"type" "enum_products_type" DEFAULT 'print',
  	"medium" varchar,
  	"dimensions" varchar,
  ...
  CREATE TABLE "_products_v" (
  	...
  	"version_price_in_u_s_d_enabled" boolean,
  	"version_price_in_u_s_d" numeric,
  	"version_type" "enum__products_v_version_type" DEFAULT 'print',
  	"version_medium" varchar,
  	"version_dimensions" varchar,
  	"version_sold" boolean DEFAULT false,
  	"version_price_in_i_l_s" numeric,
  	"version_price_in_i_l_s_enabled" boolean DEFAULT true,
  	"version_generate_slug" boolean DEFAULT true,
  	"version_slug" varchar,
