...
import { Address, Media as MediaType, Variant, VariantOption } from '@/payload-types'
          ...
          {cart?.items?.map((item, index) => {
            if (typeof item.product === 'object' && item.product) {
              ...
              if (isVariant) {
                ...
                const imageVariant = product.gallery?.find((item: { image: number | MediaType; variantOption?: (number | null) | VariantOption; id?: string | null }) => {
